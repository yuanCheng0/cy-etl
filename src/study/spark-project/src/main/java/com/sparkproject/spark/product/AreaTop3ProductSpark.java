...
//		sqlContext.setConf("spark.sql.shuffle.partitions", "1000"); //调整shuffle reduce Task数
//		sqlContext.setConf("spark.sql.autoBroadcastJoinThreshold", "20971520");//调节内置map join阈值
